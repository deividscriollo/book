                            ...
                            beforeSend: function() {
                                ...
                                $.blockUI({
                                    ...
                                    message: '<h3>Consultando, Por favor espere un momento...'
                                        ...
                                        + '<span class="loader animated fadeIn handle ui-sortable-handle">' + '<span class="spinner">' + '<i class="fa fa-spinner fa-spin"></i>' + '</span>' + '</span>' + '</h3>'
                                });
                            },
                            success: function(data) {
                                $.unblockUI();
                ...
                $.ajax({
                    ...
                    beforeSend: function() {
                        ...
                        $.blockUI({
                            ...
                            message: '<h3>Guardando su información...' + '<span class="loader animated fadeIn handle ui-sortable-handle">' + '<span class="spinner">' + '<i class="fa fa-spinner fa-spin"></i>' + '</span>' + '</span>' + '</h3>'
                        });
                    },
                    success: function(data) {
                        $.unblockUI();
