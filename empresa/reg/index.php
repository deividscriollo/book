...
<head>
    ...
    <link href="../../assets/dist/css/login_empresa.css" rel="stylesheet">
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse">
            ...
            <div class="navbar-left">
                <img src="../../assets/dist/img/logo.fw.png" class="dcimg">
            </div>
    ...
    <!-- <div class="row"> -->
        <div class="row gallery">
            <div class="col-xs-12 col-sm-12 col-md-2 col-lg-2">
                <div class="thumbnail">
                    <img src="../../assets/dist/img/logo_publi.png" alt="logotipo">
                    <div class="caption">
