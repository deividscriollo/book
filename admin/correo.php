...
function activacion_cuenta($correo,$empresa,$ruc,$id){
	...
	// Additional headers
	$headers .= 'To: WebMaster <webmaster@nextbook.ec>, Desarrollo <desarrollo@nextbook.ec>' . "\r\n";
	$headers .= 'From: Nextbook nueva cuenta <webmaster@nextbook.ec>' . "\r\n";
	$headers .= 'Cc: webmaster@nextbook.ec' . "\r\n";
	$headers .= 'Bcc: webmaster@nextbook.ec' . "\r\n";
	// Mail it
	$acu=0;
	if (mail($correo, $titulo, $contenido_html, $headers)) {
		$acu=1;
	};
	return $acu;
}
function activacion_correo($correo,$empresa,$ruc,$id, $user, $passwor){
	...
	$headers .= "Content-Type: text/html; charset=\"iso-8859-1\"\n";
	$headers .= 'To: WebMaster <webmaster@nextbook.ec>, Desarrollo <desarrollo@nextbook.ec>' . "\r\n";
	$headers .= 'From: Bienvenido a Nextbook<webmaster@nextbook.ec>';
	// Mail it
	$acu=0;
	if (mail($correo, $titulo, $contenido_html, $headers)) {
		$acu=1;
...
function respuesta($correo,$empresa,$mensaje){
	...
	// Additional headers
	$headers .= 'To: WebMaster <webmaster@nextbook.ec>, Desarrollo <desarrollo@nextbook.ec>' . "\r\n";
	$headers .= 'From: Facturanext <webmaster@nextbook.ec>' . "\r\n";
	$headers .= 'Cc: webmaster@nextbook.ec' . "\r\n";
	$headers .= 'Bcc: webmaster@nextbook.ec' . "\r\n";
	// Mail it
	$acu=0;
